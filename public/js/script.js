const questions = {
    en: [
        ...
        { id: 4, q: "How do I verify my attendance using the smart ID card?", a: "<img src=\"img/attend1.jpeg\" alt=\"\" class=\"mb-4\"><img src=\"img/attend2.jpeg\" alt=\"\">" },
        { id: 5, q: "Is there available parking?", a: "<img src=\"img/parking.jpeg\" alt=\"\">" },
        { id: 6, q: "When will the next metro arrive?", a: "<img src=\"img/metro.jpeg\" alt=\"\">" },
    ...
    ar: [
        ...
        { id: 5, q: "هل يوجد مكان لوقوف السيارات متاح؟", a: "<img src=\"img/parking.jpeg\" alt=\"\">" },
        { id: 6, q: "متى ستصل أقرب مترو؟", a: "<img src=\"img/metro.jpeg\" alt=\"\">" },
...
function scrollToBottom() {
    ...
    if (bottomElement) {
        var images = bottomElement.getElementsByTagName('img');
        if (images.length > 0) {
            var loadedImages = 0;
